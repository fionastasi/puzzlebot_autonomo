...
class SignDetecionNode(Node):
    ...
    def __init__(self):
        ...
        self.pub = self.create_publisher(Image, 'signs_detection_camera', 10)
        ...
        self.model = YOLO("/home/danieldrg/Python/runs/detect/train2/weights/best.pt")  # Ruta al modelo entrenado
    ...
    def camera_callback(self, msg):
        try:
            ...
            #self.cv_img = self.cv_img[0:160, 0:80] #SOLO PARA PUZZLEBOT
    ...
    def timer_callback(self):
        ...
        for box in results.boxes:
            ...
            if conf > 0.75 and label in ['danger', 'giveaway', 'straight', 'left', 'right', 'stop'] and area > min_area and area < max_area:
        ...
        if detected_color:
            self.pub_sign.publish(String(data=detected_color))
            print(detected_color)
        else:
            self.pub_sign.publish(String(data="none"))
